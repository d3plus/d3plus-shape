...
},{"./defaults.js":99,"d3-arrays":100,"d3-color":95}],99:[function(require,module,exports){
"use strict";
...
},{"d3-scale":96}],100:[function(require,module,exports){
if (typeof Map === "undefined") {
  Map = function() { this.clear(); };
  Map.prototype = {
    set: function(k, v) { this._[k] = v; return this; },
...
var DataPoint = (function (_Shell) {
  _inherits(DataPoint, _Shell);

  /**
    Custom data point class that enables smart variable caching.
    @param {Object} data A data object with key/value pairs.
    @param {Map} [settings = new Map()] A map of key/fetch values that dictates how to read/interprete the keys present in the data.
    @property {Object} data The data object passed to the constructor by the user.
    @property {Map} cache A Map that caches the fetched values. Gets flushed by the "clear" method.
  */
  ...
  function DataPoint(data) {
    ...
    _get(Object.getPrototypeOf(DataPoint.prototype), "constructor", this).call(this, settings);
    this.data = data;
    this.cache = new Map();
  }

  /**
    Clears the data cache for any settings attribute that has changed or is a function.
    @returns {DataPoint}
  */
  ...
  _createClass(DataPoint, [{
    ...
    /**
      Uses the settings attributes to fetch the appropriate value from the data. Fetches the value either from cache or from the data itself (and then caches it).
      @param {String} name The key name to fetch.
      @returns {value}
    */
  }, {
    key: "fetch",
...
},{"d3-selection":102,"d3plus-shell":104}],102:[function(require,module,exports){
if (typeof Map === "undefined") {
  Map = function() { this.clear(); };
  Map.prototype = {
    set: function(k, v) { this._[k] = v; return this; },
...
var Attr = (function () {
  ...
  /**
    An attribute object with helpful features.
  ...
  */
  ...
  /**
    ...
    @param {Function|Number|String} value
    @property {Function|Number|String} value The user defined value.
    @property {Constructor} type The constructor object of the user value.
    @property {Boolean} changed Sets to true when the value has been updated. The Shell class has a method that resets this value for all attributes.
    @returns {Attr}
  */
...
/**
  Abstract Class that supports getting and setting attributes.
*/

var Shell = (function () {

  /**
      @param {Map} [settings = new Map()] A map of user settings.
      @property {Map} settings The settings set by the user.
  */
  ...
  /**
    Sets a lookup attribute.
    @param {String} name The string representation for the lookup.
    @param {Function|Number|String} [value] The value to be used. If not passed, the current value will be returned instead of the Shell instance.
    @returns {Shell|value}
  */
  ...
  _createClass(Shell, [{
    ...
    value: function attr(name, value) {
      ...
      if (this.settings.has(name)) {
        this.settings.get(name).update(value);
      } else {
        this.settings.set(name, new Attr(value));
      }
    ...
    /**
      A way to set multiple attributes with key/value pairs.
      @param {Object} obj
      @returns {Shell}
    */
  }, {
    ...
    /**
      Returns the attribute object for a given key.
      @param {String} name
      @returns {Attr}
    */
  }, {
    ...
    /**
      Sets the "changed" state of all attributes to false.
      @returns {Shell}
    */
  }, {
    key: "reset",
...
},{"./Attr.js":103}],105:[function(require,module,exports){
"use strict";

require("babelify/polyfill");
module.exports = {'Abstract': require('./types/Abstract.js'),'Rectangle': require('./types/Rectangle.js')};

},{"./types/Abstract.js":106,"./types/Rectangle.js":107,"babelify/polyfill":93}],106:[function(require,module,exports){
"use strict";
...
var Abstract = (function (_Shell) {
  _inherits(Abstract, _Shell);
  ...
  _createClass(Abstract, [{
    ...
    */
    ...
    value: function draw(timing) {
      ...
      var type = this.name;
      this.groups = this.container.selectAll("g.d3plus-shape-" + type).data(this.dataArray, function (d, i) {
        d.clear();
        d.id = d.fetch("id") || i;
        return d.id;
      });
      ...
      this.enter = this.groups.enter().append("g").attr("class", "d3plus-shape-" + type).attr("id", function (d) {
...
},{"d3":97,"d3plus-datapoint":101,"d3plus-shell":104}],107:[function(require,module,exports){
"use strict";
...
var Rectangle = (function (_Abstract) {
  _inherits(Rectangle, _Abstract);
  ...
  _createClass(Rectangle, [{
    ...
    value: function animation() {
      ...
      /* Enter */
      this.enter.append("rect").attr("width", 0).attr("height", 0).attr("x", function (d) {
        return d.fetch("x");
      }).attr("y", function (d) {
        return d.fetch("y");
      ...
      /* Update */
      this.update.select("rect").transition().duration(this.timing).attr("width", function (d) {
      ...
      /* Exit */
      this.exit.select("rect").transition().duration(this.timing).attr("width", 0).attr("height", 0).attr("x", function (d) {
        return d.fetch("x");
      }).attr("y", function (d) {
        return d.fetch("y");
      });
...
},{"./Abstract.js":106,"d3plus-color":98}]},{},[105]);
